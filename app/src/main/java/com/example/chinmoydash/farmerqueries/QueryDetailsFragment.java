...
import com.example.chinmoydash.farmerqueries.firebasedata.Replies;
...
public class QueryDetailsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
       ...
       question.setText(intent.getStringExtra(getString(R.string.questionsKey)));
        mRepliesReference = mDatabase.getReference().child("questions").child(intent.getStringExtra(getString(R.string.questionkey)))
    ...
    void replyToQuestion() {
        ...
        Replies userReply = new Replies(user.getDisplayName(), answer);
        metAnswer.setText("");
